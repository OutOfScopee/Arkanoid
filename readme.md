...
pyinstaller --add-data "graphics\background.jpg;.\graphics" --add-data "graphics\background1.jpg;.\graphics" --add-data "graphics\ball.png;.\graphics" --add-data "graphics\block.png;.\graphics" arkanoid\main.py